...
enum class Violation(val fancyName: String) {
    ...
    BOAT_MOVE(API.getConfiguredCheckName(Enums.HackType.BoatMove)),
    FAST_BOW(API.getConfiguredCheckName(Enums.HackType.ElytraMove)),
    FAST_CLICKS(API.getConfiguredCheckName(Enums.HackType.BoatMove)),
    FAST_HEAL(API.getConfiguredCheckName(Enums.HackType.FastHeal)),
    FLY(API.getConfiguredCheckName(Enums.HackType.Fly)),
